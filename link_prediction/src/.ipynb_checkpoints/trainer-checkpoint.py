...
def main():
    ...
    model_name = 'imdb'
    # 加载图和数据
    graph_path = "link_prediction/graph/FB-AUTO/edgelist_new.txt"
    embedding_path1 = 'link_prediction/embeddings/FB-AUTO/NHNE_best_embeddings_1.pkl'
    #embedding_path2 = 'link_prediction/embeddings/imdb/NHNE_best_embeddings_2.pkl'
    # 加载图
    
    G = read_graph(graph_path,model_name)
    n = len(G.nodes())
    data_dir =f'link_prediction/graph/imdb/valid.edgelist'
    # 只使用一个向量：
